...
public class ExercisesActivity extends AppCompatActivity {
    ...
    private com.google.android.material.card.MaterialCardView cardViewExercise1, cardViewExercise2, cardViewExercise3, cardViewExercise4;
        ...
        weekRef.child(week_year).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.getValue() == null)
                {
                    ...
                    weekRef.child(week_year).setValue(new ProgressWeek(weekName, days, snapshot.getKey()));
                }
            }
